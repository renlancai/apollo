...
public:
    ...
    inline float GetMapResolution() const {
        return this->map_config_->map_resolutions_[
...
protected:
    ...
    BaseMapNodeConfig* map_node_config_;
    ...
    BaseMapMatrixHandler* map_matrix_handler_;
    ...
    mutable unsigned int uncompressed_file_body_size_;
...
#endif //MODULES_LOCALIZATION_MSF_LOCAL_MAP_BASE_MAP_BASE_MAP_NODEX_H