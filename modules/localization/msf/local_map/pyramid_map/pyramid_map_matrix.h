 ...
 *****************************************************************************/
#ifndef MODULES_LOCALIZATION_MSF_LOCAL_MAP_PYRAMID_MAP_MATRIX_H
#define MODULES_LOCALIZATION_MSF_LOCAL_MAP_PYRAMID_MAP_MATRIX_H
...
public:
    ...
    /**@brief Propagate the data from fine level to the coarse resolution by check. */
    void BottomUpSafe();
    /**@brief Propagate the data from fine level to the coarse resolution by check. 
    ...
    */
    ...
    const float* GetIntensitySafe(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;
    /**@brief Get an intensity variance value by check. */
    const float* GetIntensityVarSafe(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;
    /**@brief Get an altitude value by check. */
    const float* GetAltitudeSafe(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;
    /**@brief Get an altitude variance value by check. */
    const float* GetAltitudeVarSafe(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;
    /**@brief Get an altitude ground value by check. */
    const float* GetGroundAltitudeSafe(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;
    /**@brief Get a count value by check. */
    const unsigned int* GetCountSafe(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;
    /**@brief Get a ground count value by check. */
    const unsigned int* GetGroundCountSafe(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;
    ...
    FloatMatrix* GetIntensityMatrixSafe(
        unsigned int level = 0);
    FloatMatrix* GetIntensityVarMatrixSafe(
        unsigned int level = 0);
    FloatMatrix* GetAltitudeMatrixSafe(
        unsigned int level = 0);
    FloatMatrix* GetAltitudeVarMatrixSafe(
        unsigned int level = 0);
    FloatMatrix* GetGroundAltitudeMatrixSafe(
        unsigned int level = 0);
    UIntMatrix* GetCountMatrixSafe(
        unsigned int level = 0);
    UIntMatrix* GetGroundCountMatrixSafe(
        unsigned int level = 0);

    const FloatMatrix* GetIntensityMatrixSafe(
        unsigned int level = 0) const ;
    const FloatMatrix* GetIntensityVarMatrixSafe(
        unsigned int level = 0) const ;
    const FloatMatrix* GetAltitudeMatrixSafe(
        unsigned int level = 0) const ;
    const FloatMatrix* GetAltitudeVarMatrixSafe(
        unsigned int level = 0) const ;
    const FloatMatrix* GetGroundAltitudeMatrixSafe(
        unsigned int level = 0) const ;
    const UIntMatrix* GetCountMatrixSafe(
        unsigned int level = 0) const ;
    const UIntMatrix* GetGroundCountMatrixSafe(
        unsigned int level = 0) const ;

    void SetIntensityMatrix(
        const float* input, unsigned int size, unsigned int start_index,
        unsigned int level = 0);
    void SetIntensityVarMatrix(
        const float* input, unsigned int size, unsigned int start_index,
        unsigned int level = 0);
    void SetAltitudeMatrix(
        const float* input, unsigned int size, unsigned int start_index,
        unsigned int level = 0);
    void SetAltitudeVarMatrix(
        const float* input, unsigned int size, unsigned int start_index,
        unsigned int level = 0);
    void SetGroundAltitudeMatrix(
        const float* input, unsigned int size, unsigned int start_index,
        unsigned int level = 0);
    void SetCountMatrix(
        const unsigned int* input, unsigned int size, unsigned int start_index,
        unsigned int level = 0);
    void SetGroundCountMatrix(
        const unsigned int* input, unsigned int size, unsigned int start_index,
        unsigned int level = 0);
    ...
    */
    ...
    void SetIntensitySafe(float intensity, unsigned int row, 
            unsigned int col, unsigned int level = 0);
    ...
    void SetAltitudeSafe(float altitude, unsigned int row, 
            unsigned int col, unsigned int level = 0);
    ...
    void SetCountSafe(unsigned int count, unsigned int row, 
            unsigned int col, unsigned int level = 0);
     ...
     */
    void SetValueSafe(unsigned char intensity, float altitude, 
    ...
    void AddSampleSafe(float intensity, float altitude,
                         unsigned int row, unsigned int col,
                         unsigned int level);
    ...
    static void Reduce(PyramidMapMatrix* cells, 
     ...
     * only update count, intensity, intensity var and altitude
    */
    inline void AddSampleBase(float intensity, float altitude,
                         unsigned int row, unsigned int col,
                         unsigned int level);
    ...
    */
    ...
    inline void GetMapCellBase(float* &intensity, float* &intensity_var,
            float* &altitude, unsigned int* &count, unsigned int row, 
            unsigned int col, unsigned int level = 0);   

    /**@brief Get an intensity value without check. */
    inline const float* GetIntensity(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;
    /**@brief Get an intensity variance value by check. */
    inline const float* GetIntensityVar(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;
    /**@brief Get an altitude value without check. */
    inline const float* GetAltitude(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;
    /**@brief Get an altitude variance value without check. */
    inline const float* GetAltitudeVar(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;
    /**@brief Get an altitude ground value without check. */
    inline const float* GetGroundAltitude(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;
    /**@brief Get a count value without check. */
    inline const unsigned int* GetCount(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;
    /**@brief Get a ground count value without check. */
    inline const unsigned int* GetGroundCount(unsigned int row, 
            unsigned int col,
            unsigned int level = 0) const;

    inline FloatMatrix* GetIntensityMatrix(
        unsigned int level = 0);
    inline FloatMatrix* GetIntensityVarMatrix(
        unsigned int level = 0);
    inline FloatMatrix* GetAltitudeMatrix(
        unsigned int level = 0);
    inline FloatMatrix* GetAltitudeVarMatrix(
        unsigned int level = 0);
    inline FloatMatrix* GetGroundAltitudeMatrix(
        unsigned int level = 0);
    inline UIntMatrix* GetCountMatrix(
        unsigned int level = 0);
    inline UIntMatrix* GetGroundCountMatrix(
        unsigned int level = 0);

    inline const FloatMatrix* GetIntensityMatrix(
        unsigned int level = 0) const ;
    inline const FloatMatrix* GetIntensityVarMatrix(
        unsigned int level = 0) const ;
    inline const FloatMatrix* GetAltitudeMatrix(
        unsigned int level = 0) const ;
    inline const FloatMatrix* GetAltitudeVarMatrix(
        unsigned int level = 0) const ;
    inline const FloatMatrix* GetGroundAltitudeMatrix(
        unsigned int level = 0) const ;
    inline const UIntMatrix* GetCountMatrix(
        unsigned int level = 0) const ;
    inline const UIntMatrix* GetGroundCountMatrix(
        unsigned int level = 0) const ;     
    
private:
    /**@brief check legality of params. */
    bool CheckLegalityForGetData(unsigned int row,
                        unsigned int col,
                        unsigned int level) const;

    bool CheckLegalityForSetData(unsigned int level,
...
inline bool PyramidMapMatrix::HasIntensity() const{
    return has_intensity_;
}
...
inline bool PyramidMapMatrix::HasAltitude() const{
...
inline bool PyramidMapMatrix::HasCount() const{
    return has_count_;
}
...
inline unsigned int PyramidMapMatrix::GetRowsSafe(
        unsigned int level) const {
...
inline unsigned int PyramidMapMatrix::GetColsSafe(
        unsigned int level) const {
    if (level >= resolution_num_) {
...
inline unsigned int PyramidMapMatrix::GetRows(
        unsigned int level) const {
    return rows_mr_[level];
}

inline unsigned int PyramidMapMatrix::GetCols(
        unsigned int level) const {
    return cols_mr_[level];
}
...
inline void PyramidMapMatrix::GetMapCellBase(float* &intensity, float* &intensity_var,
            float* &altitude, unsigned int* &count, unsigned int row, 
...
inline const float* PyramidMapMatrix::GetIntensityVar(unsigned int row, 
            unsigned int col,
            unsigned int level) const {
...
inline const float* PyramidMapMatrix::GetGroundAltitude(unsigned int row, 
            unsigned int col,
            unsigned int level) const {
    return &ground_altitude_matrixes_[level][row][col];
}

inline const unsigned int* PyramidMapMatrix::GetCount(unsigned int row, 
            unsigned int col,
            unsigned int level) const {
    return &count_matrixes_[level][row][col];
}

inline const unsigned int* PyramidMapMatrix::GetGroundCount(unsigned int row, 
            unsigned int col,
            unsigned int level) const {
    return &ground_count_matrixes_[level][row][col];
}

inline FloatMatrix* PyramidMapMatrix::GetIntensityMatrix(
        unsigned int level) {
...
inline FloatMatrix* PyramidMapMatrix::GetAltitudeMatrix(
        unsigned int level) {
    return &altitude_matrixes_[level];
}

inline FloatMatrix* PyramidMapMatrix::GetAltitudeVarMatrix(
        unsigned int level) {
...
inline UIntMatrix* PyramidMapMatrix::GetCountMatrix(
        unsigned int level) {
    return &count_matrixes_[level];
}

inline UIntMatrix* PyramidMapMatrix::GetGroundCountMatrix(
        unsigned int level) {
...
#endif //MODULES_LOCALIZATION_MSF_LOCAL_MAP_PYRAMID_MAP_MATRIX_H