...
#ifndef MODULES_LOCALIZATION_MSF_LOCAL_MAP_PYRAMID_MAP_PYRAMID_MAP_NODE_H
#define MODULES_LOCALIZATION_MSF_LOCAL_MAP_PYRAMID_MAP_PYRAMID_MAP_NODE_H
...
public:
    ...
    */
    ...
    Eigen::Vector2d GetCoordinate(
                        unsigned int level, unsigned int x, 
                        unsigned int y) const;

    virtual bool GetCoordinate(const Eigen::Vector2d& coordinate,
                        unsigned int* x, unsigned int* y) const;
    virtual bool GetCoordinate(const Eigen::Vector3d& coordinate,
                        unsigned int* x, unsigned int* y) const;
...
#endif //MODULES_LOCALIZATION_MSF_LOCAL_MAP_PYRAMID_MAP_PYRAMID_MAP_NODE_H