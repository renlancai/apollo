...
extern PROTOBUF_INTERNAL_EXPORT_ssc_5fconfig_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_DynamicBounds_ssc_5fconfig_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_ssc_5fconfig_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_InflateSteps_ssc_5fconfig_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_ssc_5fconfig_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_SscMapCfg_ssc_5fconfig_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_ssc_5fconfig_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SscPlannerCfg_ssc_5fconfig_2eproto;
namespace planning {
namespace ssc {
class SscPlannerCfgDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<SscPlannerCfg> _instance;
} _SscPlannerCfg_default_instance_;
class InflateStepsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<InflateSteps> _instance;
} _InflateSteps_default_instance_;
class DynamicBoundsDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<DynamicBounds> _instance;
} _DynamicBounds_default_instance_;
class SscMapCfgDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<SscMapCfg> _instance;
...
static void InitDefaultsscc_info_Config_ssc_5fconfig_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::planning::ssc::_Config_default_instance_;
    new (ptr) ::planning::ssc::Config();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::planning::ssc::Config::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_Config_ssc_5fconfig_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_Config_ssc_5fconfig_2eproto}, {
      &scc_info_SscPlannerCfg_ssc_5fconfig_2eproto.base,
      &scc_info_SscMapCfg_ssc_5fconfig_2eproto.base,}};

static void InitDefaultsscc_info_DynamicBounds_ssc_5fconfig_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::planning::ssc::_DynamicBounds_default_instance_;
    new (ptr) ::planning::ssc::DynamicBounds();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::planning::ssc::DynamicBounds::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_DynamicBounds_ssc_5fconfig_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_DynamicBounds_ssc_5fconfig_2eproto}, {}};

static void InitDefaultsscc_info_InflateSteps_ssc_5fconfig_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::planning::ssc::_InflateSteps_default_instance_;
    new (ptr) ::planning::ssc::InflateSteps();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::planning::ssc::InflateSteps::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_InflateSteps_ssc_5fconfig_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_InflateSteps_ssc_5fconfig_2eproto}, {}};

static void InitDefaultsscc_info_SscMapCfg_ssc_5fconfig_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::planning::ssc::_SscMapCfg_default_instance_;
    new (ptr) ::planning::ssc::SscMapCfg();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::planning::ssc::SscMapCfg::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_SscMapCfg_ssc_5fconfig_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_SscMapCfg_ssc_5fconfig_2eproto}, {
      &scc_info_DynamicBounds_ssc_5fconfig_2eproto.base,
      &scc_info_InflateSteps_ssc_5fconfig_2eproto.base,}};

static void InitDefaultsscc_info_SscPlannerCfg_ssc_5fconfig_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::planning::ssc::_SscPlannerCfg_default_instance_;
    new (ptr) ::planning::ssc::SscPlannerCfg();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::planning::ssc::SscPlannerCfg::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SscPlannerCfg_ssc_5fconfig_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_SscPlannerCfg_ssc_5fconfig_2eproto}, {}};
...
const char descriptor_table_protodef_ssc_5fconfig_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_ssc_5fconfig_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_ssc_5fconfig_2eproto_sccs[5] = {
  &scc_info_Config_ssc_5fconfig_2eproto.base,
  &scc_info_DynamicBounds_ssc_5fconfig_2eproto.base,
  &scc_info_InflateSteps_ssc_5fconfig_2eproto.base,
  &scc_info_SscMapCfg_ssc_5fconfig_2eproto.base,
  &scc_info_SscPlannerCfg_ssc_5fconfig_2eproto.base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ssc_5fconfig_2eproto = {
  false, false, descriptor_table_protodef_ssc_5fconfig_2eproto, "ssc_config.proto", 833,
  &descriptor_table_ssc_5fconfig_2eproto_once, descriptor_table_ssc_5fconfig_2eproto_sccs, descriptor_table_ssc_5fconfig_2eproto_deps, 5, 0,
  schemas, file_default_instances, TableStruct_ssc_5fconfig_2eproto::offsets,
  file_level_metadata_ssc_5fconfig_2eproto, 5, file_level_enum_descriptors_ssc_5fconfig_2eproto, file_level_service_descriptors_ssc_5fconfig_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_ssc_5fconfig_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_ssc_5fconfig_2eproto)), true);
namespace planning {
namespace ssc {
...
const SscPlannerCfg& SscPlannerCfg::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_SscPlannerCfg_ssc_5fconfig_2eproto.base);
...
const InflateSteps& InflateSteps::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_InflateSteps_ssc_5fconfig_2eproto.base);
  return *internal_default_instance();
}
...
const DynamicBounds& DynamicBounds::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_DynamicBounds_ssc_5fconfig_2eproto.base);
  return *internal_default_instance();
}
...
void SscMapCfg::InitAsDefaultInstance() {
  ::planning::ssc::_SscMapCfg_default_instance_._instance.get_mutable()->dyn_bounds_ = const_cast< ::planning::ssc::DynamicBounds*>(
      ::planning::ssc::DynamicBounds::internal_default_instance());
  ::planning::ssc::_SscMapCfg_default_instance_._instance.get_mutable()->infl_steps_ = const_cast< ::planning::ssc::InflateSteps*>(
      ::planning::ssc::InflateSteps::internal_default_instance());
}
...
void SscMapCfg::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_SscMapCfg_ssc_5fconfig_2eproto.base);
  ::memset(&dyn_bounds_, 0, static_cast<size_t>(
...
void Config::InitAsDefaultInstance() {
  ::planning::ssc::_Config_default_instance_._instance.get_mutable()->planner_cfg_ = const_cast< ::planning::ssc::SscPlannerCfg*>(
      ::planning::ssc::SscPlannerCfg::internal_default_instance());
  ::planning::ssc::_Config_default_instance_._instance.get_mutable()->map_cfg_ = const_cast< ::planning::ssc::SscMapCfg*>(
      ::planning::ssc::SscMapCfg::internal_default_instance());
}
...
void Config::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Config_ssc_5fconfig_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  version_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  status_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ::memset(&planner_cfg_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&map_cfg_) -
