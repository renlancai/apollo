...
class SscPlannerCfg PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_ssc_5fconfig_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
inline ::planning::ssc::DynamicBounds* SscMapCfg::release_dyn_bounds() {
  auto temp = unsafe_arena_release_dyn_bounds();
  if (GetArena() != nullptr) {
...
inline ::planning::ssc::InflateSteps* SscMapCfg::release_infl_steps() {
  auto temp = unsafe_arena_release_infl_steps();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline std::string* Config::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:planning.ssc.Config.name)
...
inline void Config::unsafe_arena_set_allocated_name(
  ...
  name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:planning.ssc.Config.name)
}
...
inline std::string* Config::unsafe_arena_release_version() {
  // @@protoc_insertion_point(field_unsafe_arena_release:planning.ssc.Config.version)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
...
inline void Config::unsafe_arena_set_allocated_version(
  ...
  version_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      version, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:planning.ssc.Config.version)
}
...
inline std::string* Config::unsafe_arena_release_status() {
  // @@protoc_insertion_point(field_unsafe_arena_release:planning.ssc.Config.status)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000004u;
...
inline void Config::unsafe_arena_set_allocated_status(
  ...
  status_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      status, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:planning.ssc.Config.status)
}
...
inline ::planning::ssc::SscPlannerCfg* Config::release_planner_cfg() {
  auto temp = unsafe_arena_release_planner_cfg();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
...
inline ::planning::ssc::SscMapCfg* Config::release_map_cfg() {
  auto temp = unsafe_arena_release_map_cfg();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
